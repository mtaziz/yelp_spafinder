...
class SpafinderSpider(CrawlSpider):
	name = 'spafinder_hawaii'
	allowed_domains = ['yelp.com']
	custom_settings = {'CRAWLERA_PRESERVE_DELAY': True, 'DOWNLOAD_DELAY': 10.0}
	spafinder_start_urls = ["http://www.yelp.com/search?find_desc=spa&find_loc=hawaii&start=0&cflt=spas"]
						   # http://www.yelp.com/search?find_desc=spa&find_loc=hawaii&start=0&cflt=spas
	...
	for i in range(10, 160, 10):
		spafinder_start_urls.append('http://www.yelp.com/search?find_desc=spa&cflt=spas&find_loc=hawaii&start={0}'.format(i))
